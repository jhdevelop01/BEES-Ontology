...
> **조사 일자:** 2026.02.10
> **조사 범위:** 삼성E&A 지속가능경영보고서 (2020~2024), 삼성물산 지속가능경영보고서, 공개 데이터, DART 사업보고서
...
| B동 추정 (연면적 비율 33%~35%) | 53.5 GWh x 0.33 | **약 17.7 GWh/년** (추정) |
| B동 추정 (TJ) | 192.4 TJ x 0.33 | **약 63.5 TJ/년** (추정) |

> **주의:** 1차 에너지 소요량은 설계 기준이며, 실제 운영 에너지 사용량과 차이가 있을 수 있음.
> 1차 에너지에는 에너지 생산/전환 과정의 손실이 포함되어 실제 소비량보다 높음.
> B동 면적 비율은 전체 186,023 m2 대비 약 60,000~65,000 m2로 추정(약 33~35%).
...
4. **고소비 건물 공개 제도**
   ...
   - GEC (186,023 m2)는 해당 대상일 가능성 매우 높음
...
### 6.3 에너지 사용량 추정값 (Brick Point 기준)

| Point 유형 | GEC 전체 추정 | B동 추정 (33%) | 단위 | 근거 |
|-----------|-------------|--------------|------|------|
| 연간 1차 에너지 | 53,454,610 | 17,640,022 | kWh/년 | 287.4 kWh/m2 x 면적 |
| 연간 1차 에너지 (TJ) | 192.4 | 63.5 | TJ/년 | 환산 |
| 연간 1차 에너지 (MJ) | 192,436,596 | 63,504,077 | MJ/년 | 환산 |
| 월평균 전력 | 4,454,551 | 1,470,002 | kWh/월 | 12등분 |
| 일평균 전력 | 146,450 | 48,329 | kWh/일 | 365등분 |

> **주의:** 이는 설계 기준 1차 에너지 소요량에서 역산한 추정치이며, 실제 운영 데이터와 상이할 수 있음.
...
| 8 | **고소비건물 에너지 공개** GEC 해당 여부 | 서울시 에너지정보 | 연간 TOE 단위 에너지 사용량 |
